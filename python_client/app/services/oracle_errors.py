...
def map_oracle_error(exc: Exception) -> str:
    if isinstance(exc, oracledb.DatabaseError):
        ...
        custom = {
            ...
            -20072: "Эта лаборатория уже открыта в другой активной сессии. Закройте другое окно игры или выйдите из лаборатории там.",
            -20073: "Выбранная лаборатория не активна в текущей сессии. Вернитесь к выбору лаборатории и откройте её заново.",
        }
