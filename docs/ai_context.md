...
## ???????? ??????? ??????? ?????? (?????????????)
- Backend strict-pass, content compliance pass, economy pass ? multiuser strict-pass ????????? ?????????.
- Smoke-tests `01..08` ? ??????? ? ?????????? baseline.
- GUI ?????????? ?? ???? ???????? ????????; Python ???????? ?????? GUI-????????.
- ??????????? ?????? GUI ???????: `? ????????????` ??? logout, `????? ?? ????????` ? logout, ???????? ????? `X` ????????? ?????????? logout ? ???????? ???????????.
- ??? ?????????????? ?????? ???????? ?????? ????? ?????????? ???????? ?????? ?????? GUI ???? dev-only ??????: `database/scripts/dev_unlock_stale_sessions.sql`.
- ??????? ????????????? ?????????? ???????? `experiments.created_at`.
- ????????? ??????? (`??????/???????/???????`) ??????????? ??? display-layer ????????? GUI, ? ?? ??? ???? ??.
- SQL smoke-tests ?? ????????? ?????? ????????? ????????; ??? ????????? ???????????? ?????? `tasks/task_markers` ? ???????????? ???????.

## ??????? pending ???
????? ????????? content/GUI pass ?? ????????????? ???????:
- ??????? tutorial/find-?????? ????????????? ??? `???????/????????/??????????`;
- ?? ??????? ???????????? ????????????? ???????? ????? ???????????/???????, ???? backend ??? ?? ?????????;
- ???? ? ??????? ??????????? ????????? `FIND/BREED/MUTATE` ?? ?????? ??????, ??? ????????? DDL/backend-????.
