...
def map_oracle_error(exc: Exception) -> str:
    if isinstance(exc, oracledb.DatabaseError):
        ...
        custom = {
            ...
            -20045: "Существо несовместимо с правилом выбранной мутации. Попробуйте другое существо или другую мутацию.",
            ...
            -20088: "Эта мутация недоступна для генетической модели данной лаборатории.",
            -20089: "Мутация не может заменить аллель тем же значением.",
            -20090: "Не удалось завершить комбинированный эксперимент.",
            -20091: "Гибрид нельзя использовать в качестве родителя.",
            -20092: "Гибридизация доступна только в лаборатории генетической модели 3.",
            -20093: "Для гибридизации выберите существ двух разных видов.",
            -20094: "Для контролируемой гибридизации доступно только облучение.",
            -20095: "Настройки контролируемой гибридизации недоступны.",
            -20096: "Каноническая генетическая модель гибрида должна содержать ровно 19 генов.",
            -20097: "У одного из родителей отсутствует полный набор генов версии 3.",
            -20098: "Итоговый генотип гибрида не соответствует канонической модели версии 3.",
            -20063: "Существо не подходит под требования задания. Выберите другое существо или сначала получите нужные признаки через скрещивание/мутации.",
            -20070: "Поддерживаются только облучение и химический мутаген.",
            ...
            -20079: "Изменять профиль может только его владелец в активной сессии.",
        }
