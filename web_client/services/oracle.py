...
def map_oracle_error(exc: Exception) -> str:
    if isinstance(exc, oracledb.DatabaseError):
        ...
        custom = {
            ...
            -20072: "Лаборатория уже открыта в другой сессии. Сначала закройте активную лабораторию кнопкой ниже, затем откройте нужную. Если это другая вкладка или старый вход, выйдите и войдите заново.",
