...
def map_oracle_error(exc: Exception) -> str:
    if isinstance(exc, oracledb.DatabaseError):
        ...
        custom = {
            ...
            -20051: "Backend не смог выбрать ген для химического мутагена.",
            ...
            -20072: "Эта лаборатория уже открыта в другой активной сессии.",
        ...
        if message:
            return f"Произошла ошибка Oracle. Технические детали: {message}"
