...
begin
    ...
    begin
        ...
        assert_true(v_creature_count = 30, 'get_lab_stats creature_count', 'expected 30');
        assert_true(
            v_active_task_count = 3,
            'get_lab_stats active_task_count (start_new_lab creates lab, generates 30 creatures, and assigns 3 ACTIVE tasks)',
            'expected 3'
        );
