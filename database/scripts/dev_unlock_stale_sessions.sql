-- Только для разработки: освобождение устаревших ACTIVE-сессий после аварийного закрытия GUI.
-- Назначение:
--   Только для восстановления в разработке, если старая версия GUI была закрыта аварийно
